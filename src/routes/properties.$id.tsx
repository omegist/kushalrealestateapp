...
function PropertyDetails() {
  ...
  whatsappLink(
    ...
    defaultEnquiryMessage(property.title)
  );
...
className={cn(
"h-16 w-20 rounded-xl overflow-hidden",
i===activeImg &&
...
<PropertyVideo url={property.video_url} poster={property.cover_image} title={property.title} />
...
<span
key={a}
className="px-3 py-2 rounded-full border bg-card text-xs">
